...
.rg-bt-side{position:absolute;inset:0;display:flex;align-items:flex-end;pointer-events:none}.rg-bt-allies{left:4%;right:51%;justify-content:space-around;padding-bottom:28px}.rg-bt-enemies{left:53%;right:4%;justify-content:center;padding-bottom:35px}
